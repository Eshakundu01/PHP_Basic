...
require '../../task_oops/class-name.php';
require '../../task_oops/class-image.php';
require '../../task_oops/class-marks.php';
require '../../task_oops/class-number.php';
require '../../task_oops/class-mail.php';
